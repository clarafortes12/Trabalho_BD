...
CREATE TABLE IF NOT EXISTS `hospital`.`Endereco` (
  ...
  PRIMARY KEY (`idEndereco`, `Tipo_Endereco_idTipo_Endereco`, `Bairro_idBairro`),
...
CREATE TABLE IF NOT EXISTS `hospital`.`Ala` (
  `cod_Ala` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `hospital`.`Telefone` (
  ...
  PRIMARY KEY (`idTelefone`, `Cidade_idCidade`, `Tipo_Telefone_idTipo_Telefone`),
...
CREATE TABLE IF NOT EXISTS `hospital`.`Enfermaria` (
  `cod_Enfermaria` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `hospital`.`Equipamento` (
  `cod_Equipamento` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `hospital`.`Laboratorio` (
  ...
  `Endereco_idEndereco` INT NOT NULL,
  PRIMARY KEY (`cod_Laboratorio`, `Endereco_idEndereco`),
  INDEX `fk_Laboratorio_Endereco1_idx` (`Endereco_idEndereco` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `hospital`.`Consulta` (
  ...
  `Enfermaria_cod_Enfermaria` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`cod_Consulta`, `Medico_CRM`, `Paciente_cod_Paciente`, `Enfermaria_cod_Enfermaria`),
  INDEX `fk_Consulta_Medico1_idx` (`Medico_CRM` ASC) VISIBLE,
  INDEX `fk_Consulta_Paciente1_idx` (`Paciente_cod_Paciente` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `hospital`.`Exame` (
  ...
  PRIMARY KEY (`cod_Exame`, `Consulta_cod_Consulta`, `Laboratorio_cod_Laboratorio`, `Enfermeiro_COREN`),
  INDEX `fk_Exame_Consulta1_idx` (`Consulta_cod_Consulta` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `hospital`.`Receita` (
  ...
  `Consulta_cod_Consulta` INT NOT NULL,
  PRIMARY KEY (`idReceita`, `Consulta_cod_Consulta`),
  INDEX `fk_Receita_Médica_Consulta1_idx` (`Consulta_cod_Consulta` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `hospital`.`Remedio` (
  ...
  PRIMARY KEY (`idRemedio`, `Receita_idReceita`),
  INDEX `fk_Remedio_Receita1_idx` (`Receita_idReceita` ASC) VISIBLE,
