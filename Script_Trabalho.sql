...
-- Thu Nov 19 16:50:49 2020
-- Model: Hospital    Version: 1.0
...
CREATE TABLE IF NOT EXISTS `hospital`.`Medico` (
  ...
  `Funcionario_Pessoa_CPF` INT NOT NULL,
  PRIMARY KEY (`CRM`, `Funcionario_cod_Funcionario`, `Funcionario_Pessoa_CPF`),
  UNIQUE INDEX `CRM_UNIQUE` (`CRM` ASC) VISIBLE,
  INDEX `fk_Medico_Funcionario1_idx` (`Funcionario_cod_Funcionario` ASC, `Funcionario_Pessoa_CPF` ASC) VISIBLE,
  UNIQUE INDEX `Funcionario_cod_Funcionario_UNIQUE` (`Funcionario_cod_Funcionario` ASC) VISIBLE,
  UNIQUE INDEX `Funcionario_Pessoa_CPF_UNIQUE` (`Funcionario_Pessoa_CPF` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `hospital`.`Enfermeiro` (
  ...
  `Funcionario_cod_Funcionario` INT NOT NULL,
  `Funcionario_Pessoa_CPF` INT NOT NULL,
  PRIMARY KEY (`COREN`, `Funcionario_cod_Funcionario`, `Funcionario_Pessoa_CPF`),
  UNIQUE INDEX `COREN_UNIQUE` (`COREN` ASC) VISIBLE,
  INDEX `fk_Enfermeiro_Funcionario1_idx` (`Funcionario_cod_Funcionario` ASC, `Funcionario_Pessoa_CPF` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `hospital`.`Laboratorio` (
  ...
  CONSTRAINT `fk_Laboratorio_Endereco1`
    ...
    REFERENCES `hospital`.`Endereco` (`idEndereco` , `Tipo_Endereco_idTipo_Endereco` , `UF_idUF` , `Bairro_idBairro` , `Cidade_idCidade`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
